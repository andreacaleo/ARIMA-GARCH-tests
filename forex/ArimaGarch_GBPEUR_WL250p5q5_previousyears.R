...
getFX("GBP/EUR", from = "2005-01-01", to = "2010-01-01")
...
write.table(forecasts_new, file="forecasts_GBPEUR_WL250p5q5_previousyears.csv", sep = ",",
            row.names = F, col.names = F, quote = F)

GBPEURArimaGarch = as.xts(
    read.zoo(file = "forecasts_GBPEUR_WL250p5q5_previousyears.csv", format = "%Y-%m-%d", header = F, sep = ",")
)
...
trellis.device(device = "png", filename = "Returns_GBPEUR_WL250p5q5_previousyears.png")
print(returns_plot)
dev.off()
